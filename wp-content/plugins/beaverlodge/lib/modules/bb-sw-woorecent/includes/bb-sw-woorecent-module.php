...
class SWWooRecentClass extends FLBuilderModule {

    public function __construct()
    {

        parent::__construct(array(
            'name'          => __( 'WooCommerce Recent', 'fl-builder' ),
            'description'   => __( 'Add woo recent items', 'fl-builder' ),
            'category'      => BRANDING,
            'dir'           => SW_WOORECENT_MODULE_DIR . '/',
            'url'           => SW_WOORECENT_MODULE_URL . '/',
...
FLBuilder::register_module( 'SWWooRecentClass', array(
    ...
    'content-tab'      => array(
        ...
        'sections'      => array( 
              ...
              'content_select'  => array(
                'title'         => __( 'WooCommerce Recent Items', 'fl-builder' ),
                'fields'        => array(
