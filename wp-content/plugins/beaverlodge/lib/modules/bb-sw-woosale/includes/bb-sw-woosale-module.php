...
class SWWooSaleClass extends FLBuilderModule {

    public function __construct()
    {

        parent::__construct(array(
            'name'          => __( 'WooCommerce Sale Items', 'fl-builder' ),
            'description'   => __( 'Add woo sale items', 'fl-builder' ),
            'category'      => BRANDING,
            'dir'           => SW_WOOSALE_MODULE_DIR . '/',
            'url'           => SW_WOOSALE_MODULE_URL . '/',
...
FLBuilder::register_module( 'SWWooSaleClass', array(
    ...
    'content-tab'      => array(
        ...
        'sections'      => array( 
              ...
              'content_select'  => array(
                'title'         => __( 'WooCommerce Sale Items', 'fl-builder' ),
                'fields'        => array(
